    ...
    <>
      <div className="land-container4">
        <div className="main-bar4" style={{ width: '100%' }}>
          <div className="search-container4" style={{ display: 'flex', width: '100%', alignItems: 'center', borderRadius: '50px', backgroundColor: 'var(--search-nav)' }}>
            <input
              type="text"
              ...
              style={{ flex: 1, border: 'none', padding: '10px', borderRadius: '50px 0 0 50px', outline: 'none' }}
            />
            <div style={{ width: '40px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '0 50px 50px 0', backgroundColor: 'var(--search-nav)' }}>
              <SearchIcon className="search-icon4" style={{ fontSize: '18px', fontWeight: 'bold', color: 'black' }} />
            </div>
          </div>
        </div>
