...
function LandingPage() {
  ...
  const handleAssign = () => {
    if (assignedTo === '' || taskName === '' || description === '' || dueDate === '') {
      ...
      <div className="land-container">
        <div className="main-bar">
          <div className="user-wel">
            <div className='welc'>
              <div id="welc"><h3 style={{fontWeight:"400"}}>Welcome....!!</h3></div>
            </div>
            <div className='uname'>
              <div id="uname"><h1 style={{color:"var(--uname)", marginTop:"1rem",fontWeight:"450"}}>{Userdata[0].username}</h1></div>
              <div id="desig"><h5 style={{color:"var(--uname)",fontWeight:"500"}}>{Userdata[0].designation}</h5></div>
            </div>
          </div>
        </div>
        <div className="taskbar">
          ...
          <div className="task-list">
            <form onSubmit={handleSubmit} className="form">
              ...
              <div className="btn">
                <Button variant="contained" onClick={handleCancel} id="cancel">Cancel</Button>
                <Button variant="contained" onClick={handleAssign} id="submit">Assign Task</Button>
              </div>
            </form>
            <div className="side">
